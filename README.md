...
<main>
  ...
  <section class="produtos">
    <article class="produto">
      <img src="https://via.placeholder.com/280x180?text=Labubu" alt="Boneco colecionável Labubu"/>
      <h2>Boneco Labubu</h2>
      <p class="preco-original">R$ 199,00</p>
      <p class="preco-desconto">R$ 109,45</p>
      <button onclick="adicionarAoCarrinho('Labubu', 109.45)" aria-label="Adicionar Boneco Labubu ao carrinho">Comprar</button>
    </article>

    <article class="produto">
      <img src="https://via.placeholder.com/280x180?text=Tablet+Samsung" alt="Tablet Samsung modelo infantil"/>
      <h2>Tablet Samsung</h2>
      <p class="preco-original">R$ 1.499,00</p>
      <p class="preco-desconto">R$ 824,45</p>
      <button onclick="adicionarAoCarrinho('Tablet Samsung', 824.45)" aria-label="Adicionar Tablet Samsung ao carrinho">Comprar</button>
    </article>
  </section>
</main>
